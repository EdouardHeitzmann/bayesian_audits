...
This is minimal replication code for my Bayesian Stats final project. This repo is still quite raw and poorly organized -- my apologies -- but most of the content in my writeup can be replicated using the notebook `adversarial_profile` ipynb. 
